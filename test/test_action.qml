...
ApplicationWindow {
  ...
  ColumnLayout {
    ...
    Rectangle {
      ...
      color: lastResult === null ? "#F5F5F5" : lastResult === "" ? "#E8F5E9" : "#FFEBEE"
      border.color: lastResult === null ? "#CCC" : lastResult === "" ? "#4CAF50" : "#F44336"
      ...
      Text {
        ...
        text: lastResult === null ? "(no action sent yet)" : lastResult === "" ? "✓ OK — action sent successfully" :
                                                                                 "✗ " + lastResult
        color: lastResult === null ? "#666" : lastResult === "" ? "#2E7D32" : "#C62828"
      }
    }
